...
function Footer() {
  ...
  <div className="pt-24  mx-auto grid  w-[90%] grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <div className='pb-5'>
      ...
      {/* Description */}
      <p className="mb-4">
        Located in Kwale County, Diani Beach is renowned for its white sands, turquoise waters, and vibrant culture—a true coastal gem
      </p>
      ...
      <ul className="space-y-2">
        ...
        <li className="flex items-center">
          ...
          <a href="#" className="hover:text-gray-400">+254 725 832454</a>
        </li>
    ...
    <div>
      <h3 className="text-2xl font-semibold mb-4">Social</h3>
        <ul className="space-y-2">
          ...
          <a href="https://www.facebook.com/vicmugenya" className="hover:text-gray-400">Facebook</a>
        </li>

        <li className="flex items-center">
          <BiLogoTiktok className="mr-2" />
          <a href="https://www.tiktok.com/@b.mugen?_t=ZM-8siA6DSitC2&_r=1" className="hover:text-gray-400">TikTok</a>
        </li>
        <li className="flex items-center">
          <BiLogoInstagram className="mr-2" />
          <a href="https://www.instagram.com/dianibeachrealty/profilecard/?igsh=MWhxY3FtaXc2Y2Fpeg==" className="hover:text-gray-400">Instagram</a>
        </li>
